...
export const CAFE_DATA: Cafe[] = [
  ...
  },
  {
    ...
    district: '西區',
    address: '台中市西區公益路某段',
    position: [24.99366739909826, 121.50914156577502],
    tags: ['適合工作', '不限時', '好停車', 'WiFi'],
    isFavorite: true,
    score: 4.5,
    image: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=500',
  },
  {
    ...
    district: '西區',
    address: '台中市西區公益路某段',
    position: [24.993222013512614, 121.50921310296063],
    tags: ['適合工作', '不限時', '好停車'],
    isFavorite: true,
    score: 4.5,
    image: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=500',
  },
  {
    ...
    district: '西區',
    address: '台中市西區公益路某段',
    position: [24.993367884170286, 121.50878203194273],
    tags: ['適合工作', '不限時', '好停車'],
    isFavorite: true,
    score: 4.5,
    image: 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=500',
